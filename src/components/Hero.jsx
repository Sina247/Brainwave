			...
			<div ref={parallaxRef} className="container relative">
				<div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
					<h1 className="h1 mb-6">
						...
						<Typewriter
							options={{
								strings: ["AI Chatting", "Photo Editing", "Video Generation", "Image Generation", "Code Generation"],
								autoStart: true,
								loop: true,
							}}
						/>
					...
					<p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
						Unleast the power of AI within Brainwave. Upgrade your productivity with{" "}
					...
					<div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
						<div className="relative bg-n-8 rounded-[1rem]">
							...
							<div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
								<img src={robot} className="w-full scale-[1.7] translate-y-[8%] md:scale-[1] md:-translate-y-[10%] lg:-translate-y-[23%] pointer-events-none select-none" width={1024} height={490} alt="AI" />
